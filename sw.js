const CACHE='terokaku-v1.2.0';
const CORE=['./','./index.html','./styles.css','./data.js','./deep-content.js','./encyclopedia.js','./app.js','./manifest.webmanifest','./assets/icons/icon-192.png','./assets/icons/icon-512.png'];
